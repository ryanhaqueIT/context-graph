...
BACKEND = Path(__file__).resolve().parent.parent / "src" / "context_graph"
...
def main() -> int:
    ...
    py_files = [
        ...
        and f.name != "__main__.py"  # CLI entry points may use print
        and "cli" not in f.parts  # CLI modules legitimately use print for user output
    ]
